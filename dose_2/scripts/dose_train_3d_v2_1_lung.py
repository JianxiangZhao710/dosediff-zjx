#!/usr/bin/env python3
"""
dose_train_3d_v2_1_lung.py
==========================
Single-GPU v2.1 lung training (compiler: no P_fused shortcut + softplus pos/neg).
...
# ----------------------------- CLI ARGS -----------------------------
def build_args():
    p = argparse.ArgumentParser(description="Single-GPU v2.1 lung dose training.")
    ...
    # v2.1 modules / ablation (same flags as v2.0 + full_v2_1)
...
def main():
    ...
    print(f"[v2.1] compiler=v21(no_p_bypass+softplus) router={use_router} relation={use_relation} "
