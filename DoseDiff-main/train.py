...
data_root_train = '/data1/zhaojianxiang/preprocessed_data/NPY/train'
data_root_val   = '/data1/zhaojianxiang/preprocessed_data/NPY/validation'
L2 = 0.0001
ture_bs = dist.get_world_size() * args.bs
val_bs = 2 * args.bs
